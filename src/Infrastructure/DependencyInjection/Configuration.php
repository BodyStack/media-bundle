        ...
        $treeBuilder->getRootNode()
                    ->children()
                        ...
                        ->scalarNode('user_identifier_property')
                            ->defaultValue('id')
                            ->cannotBeEmpty()
                            ->info('Required if it is different from id')
                        ->end()
                        ->scalarNode('user_name_property')
                        ...
                        ->arrayNode('image')->addDefaultsIfNotSet()
                            ->children()
                                ...
                                ->arrayNode('breakpoints')->addDefaultsIfNotSet()
                                    ->children()
                                        ->arrayNode(Breakpoint::XXLARGE->value)->prototype('scalar')->end()
                                            ->defaultValue([])
                                        ->end()
                                        ->arrayNode(Breakpoint::XLARGE->value)->prototype('scalar')->end()
                                            ->defaultValue([])
                                        ->end()
                                        ->arrayNode(Breakpoint::LARGE->value)->prototype('scalar')->end()
                                            ->defaultValue(Breakpoint::LARGE->dimensions())
                                        ->end()
                                        ->arrayNode(Breakpoint::MEDIUMPLUS->value)->prototype('scalar')->end()
                                          ->defaultValue([])
                                        ->end()
